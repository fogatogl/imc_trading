...
# V1 RESEARCH: SNK pairs restructured by coint p-value
# (round5/reports/SNACKPACK/cointegration.csv).
# DROPPED: CHOC↔VAN (p=0.462, statistically invalid)
# ADDED:   CHOC↔RASP (p=0.007), VAN↔RASP (p=0.007)
# KEPT:    PIST↔RASP, PIST↔STRAW, RASP↔STRAW (all p<0.05)
